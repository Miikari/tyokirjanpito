...
const i18n = {
    ...
    departureDate: 'Lähtöpäivä', returnDate: 'Paluupäivä',
    markMultipleDays: 'Merkkaa useita kerralla',
    perdiemDaysCountLabel: 'Vuorokausien määrä',
    perdiemDepartureAfterReturn: 'Lähtöajan täytyy olla ennen paluuaikaa',
    ...
    selectedLabel: 'valittu', actionsBtn: 'Toiminnot', clearSelection: 'Kumoa valinnat',
    deleteSelected: 'Poista valinnat', noSelection: 'Ei valittuja kirjauksia',
    deleteSelectedConfirm: 'Haluatko varmasti poistaa %d valittua kirjausta? Toimintoa ei voi perua.',
    selectionRemoved: 'Valitut kirjaukset poistettu',
  ...
  en: {
    ...
    perdiemDepartureAfterReturn: 'Departure time must be before return time',
    ...
    selectedLabel: 'selected', actionsBtn: 'Actions', clearSelection: 'Clear selection',
    deleteSelected: 'Delete selected', noSelection: 'No entries selected',
    deleteSelectedConfirm: 'Are you sure you want to delete %d selected entries? This cannot be undone.',
    selectionRemoved: 'Selected entries deleted',
